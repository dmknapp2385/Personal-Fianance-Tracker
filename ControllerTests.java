...
class ControllerTests {
    ...
    public void setup() throws NoSuchFieldException, IllegalAccessException {
        Field userField = Controller.class.getDeclaredField("users");
        Controller thisC = Controller.instanceOf();
        userField.setAccessible(true);
        userField.set(thisC, new ArrayList<User>());
        Field currField = Controller.class.getDeclaredField("currUser");
        currField.setAccessible(true);
        currField.set(thisC, Optional.empty());
    }
    ...
    void testAddBudget() {
        ...
        Optional<Double> budget = controller.getBudgetByCategory(cat);
